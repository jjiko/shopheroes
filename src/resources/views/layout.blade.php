...
@section('styles')
    ...
    <link rel="stylesheet" href="/dist/css/shop-heroes.css">
@stop
@section('app')
    @include("shopheroes::layout.search")
    @include("shopheroes::layout.navbar")
    <div id="xbx-container" class="container">
        <div class="row">
            <div class="col-sm-11">
                @if(empty($content))
                    @include('shopheroes::index')
                @else
                    <?php echo $content; ?>
                @endif
            </div>
            ...
            <div class="col-sm-1">
                <div class="row">
                    <div class="col-xs-12">@include('shopheroes::layout.brand')</div>
                </div>
            </div>
            --}}
        </div>
    ...
    @include('shopheroes::layout.modals.feedback')
    <script>
        (function() {
